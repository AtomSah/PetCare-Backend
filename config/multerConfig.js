...
const createUploadsDirectories = () => {
  const dirs = ['./uploads', './uploads/users', './uploads/pets'];
  dirs.forEach(dir => {
...
// Add this at the end of your exports
module.exports = {
  uploadUserAvatar: uploadUserAvatar.single('avatar'),
  uploadPetImage: uploadBookImages.single('image'), // Change to single image for pets
